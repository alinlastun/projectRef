package com.softvision.hope.showcase.di.util
...
import com.softvision.hope.showcase.di.components.AppComponent
import com.softvision.hope.showcase.di.components.DaggerAppComponent
...
object AppInjector : IAppInjector {
    override fun init(app: BaseApp): AppComponent {
        ...
        appComponent.inject(app as ShowcaseApp)
